...
public class OrderController {
	...
	public ResponseEntity<Orders> updateOrder(@Valid @PathVariable("orderId") Integer oId,@RequestBody Orders orders) throws CustomerException, OrderException{
		Orders od = orderService.updateOrder(oId, orders);
